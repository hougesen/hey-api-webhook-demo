...
export type EnumWithReplacedCharacters =
  | "'Single Quote'"
  | '"Double Quotes"'
  | "øæåôöØÆÅÔÖ字符串"
  | 3.1
...
export type ModelWithConstantSizeArray = [number, number];
...
export type OneOfAllOfIssue =
  | ((ConstValue | GenericSchemaDuplicateIssue1SystemBoolean) & _3eNum1Период)
  | GenericSchemaDuplicateIssue1SystemString;
...
export type ApiVVersionODataControllerCountResponse =
  ApiVVersionODataControllerCountResponses[keyof ApiVVersionODataControllerCountResponses];
...
export type GetApiVbyApiVersionSimpleOperationError =
  GetApiVbyApiVersionSimpleOperationErrors[keyof GetApiVbyApiVersionSimpleOperationErrors];
...
export type GetApiVbyApiVersionSimpleOperationResponse =
  GetApiVbyApiVersionSimpleOperationResponses[keyof GetApiVbyApiVersionSimpleOperationResponses];
...
export type PostCallWithOptionalParamResponse =
  PostCallWithOptionalParamResponses[keyof PostCallWithOptionalParamResponses];
...
export type CallWithNoContentResponseResponse =
  CallWithNoContentResponseResponses[keyof CallWithNoContentResponseResponses];
...
export type CallWithResponseAndNoContentResponseResponse =
  CallWithResponseAndNoContentResponseResponses[keyof CallWithResponseAndNoContentResponseResponses];
...
export type CallWithResponseResponse =
  CallWithResponseResponses[keyof CallWithResponseResponses];
...
export type CallWithDuplicateResponsesError =
  CallWithDuplicateResponsesErrors[keyof CallWithDuplicateResponsesErrors];
...
export type CallWithDuplicateResponsesResponse =
  CallWithDuplicateResponsesResponses[keyof CallWithDuplicateResponsesResponses];
...
export type CallWithResponsesError =
  CallWithResponsesErrors[keyof CallWithResponsesErrors];
...
export type CallWithResponsesResponse =
  CallWithResponsesResponses[keyof CallWithResponsesResponses];
...
export type ComplexTypesResponse =
  ComplexTypesResponses[keyof ComplexTypesResponses];
...
export type MultipartResponseResponse =
  MultipartResponseResponses[keyof MultipartResponseResponses];
...
export type ComplexParamsResponse =
  ComplexParamsResponses[keyof ComplexParamsResponses];
...
export type NonAsciiæøåÆøÅöôêÊ字符串Response =
  NonAsciiæøåÆøÅöôêÊ字符串Responses[keyof NonAsciiæøåÆøÅöôêÊ字符串Responses];
